            ...
            <div class="col-md-5">
                <div class="main-description px-2">
                    ...
                    <p class="old-price mb-1">Catégorie : </p>
                        <p class="new-price text-bold mb-1"><?php if (19 > 1000) {
                            echo substr_replace(19, ",", -3, 0);
                        } else {
                            echo 19;
                        } ?>  €</p>
                        <p class="text-secondary mb-1">(Quantité restante : 62)</p>
                    </div>
                    ...
                    <div class="buttons d-flex my-5">
                        ...
                        <div class="block quantity">
                            <form action="../add_to_cart.php" id="form-cart" method="post">
                                ...
                                <input type="text" name="product-name" id="product-name" value="test" hidden>
